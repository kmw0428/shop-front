...
const Login: React.FC<LoginFormProps> = () => {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post(
        "https://shoppingback-ltd0.onrender.com/api/auth/login",
        { username, password }
      );
      ...
      if (response.data && response.data.accessToken) {
        Swal.fire({
          ...
          try {
            ...
            const userResponse = await axios.get(`https://shoppingback-ltd0.onrender.com/api/users/${userId}`);
  ...
  const handleRegister = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      await axios.post("https://shoppingback-ltd0.onrender.com/api/auth/register", {
        username,
        email,
        password,
      });
